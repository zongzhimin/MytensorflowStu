...
def main():
    ...
    discriminator.load_weights(r'E:\stuCode\testData\gan_weights\d_weights.ckpt')
    ...
    for epoch in range(epochs):
        ...
        if epoch % 1000 == 0:
            ...
            discriminator.save_weights(r'E:\stuCode\testData\gan_weights\d_weights.ckpt')
            generator.save_weights(r'E:\stuCode\testData\gan_weights\g_weights.ckpt')
